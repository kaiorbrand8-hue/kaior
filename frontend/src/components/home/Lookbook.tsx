  ...
  return (
    <section className="bg-white py-20">
      ...
      <div className="mx-auto mt-12 grid max-w-7xl grid-cols-1 gap-4 px-4 sm:grid-cols-2 sm:px-6 lg:px-8">
        <div className="relative aspect-[4/5] overflow-hidden bg-navy-950 sm:aspect-auto">
          <Image
        ...
        <div className="relative flex min-h-[280px] flex-col justify-center overflow-hidden bg-navy-800 px-10 py-10 text-cream">
          <Image
